...
public class DraftAdapter extends RecyclerView
    ...
    public DataObjectHolder onCreateViewHolder(ViewGroup parent,
        ...
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.draft_row_view, parent, false);
    ...
    public void onBindViewHolder(DataObjectHolder holder, final int position) {
        ...
        holder.txt_store.setText(Html.fromHtml(mDataset.get(position).getDraft_storename() + "<small>" +
                "<font color='#AEAEAE'> (" + mDataset.get(position).getDraft_storeregion() + ") </font></small>"));
